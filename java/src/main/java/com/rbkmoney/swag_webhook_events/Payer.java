...
public class Payer {
   ...
   */
  @JsonAdapter(PayerTypeEnum.Adapter.class)
  public enum PayerTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<PayerTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PayerTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public PayerTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return PayerTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }
  ...
  * @return payerType
  **/
  @Schema(required = true, description = "Тип платежного средства")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(payerType);
  }
