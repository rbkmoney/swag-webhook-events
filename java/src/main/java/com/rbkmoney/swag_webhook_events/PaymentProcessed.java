...
/**
 * Событие об успешной обработке платежа
 */
@Schema(description = "Событие об успешной обработке платежа")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T14:43:15.170+03:00[Europe/Moscow]")public class PaymentProcessed extends Event {
  ...
  public PaymentProcessed invoice(Invoice invoice) {
  ...
  **/
  ...
  public PaymentProcessed payment(Payment payment) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentProcessed paymentProcessed = (PaymentProcessed) o;
    return Objects.equals(this.invoice, paymentProcessed.invoice) &&
        Objects.equals(this.payment, paymentProcessed.payment) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentProcessed {\n");
