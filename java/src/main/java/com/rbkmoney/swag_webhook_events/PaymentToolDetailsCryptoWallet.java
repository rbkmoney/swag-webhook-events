...
import com.rbkmoney.swag_webhook_events.CryptoCurrency;
import com.rbkmoney.swag_webhook_events.CryptoWalletDetails;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T14:43:15.170+03:00[Europe/Moscow]")public class PaymentToolDetailsCryptoWallet extends PaymentToolDetails {

  @SerializedName("cryptoCurrency")
  private CryptoCurrency cryptoCurrency = null;
  public PaymentToolDetailsCryptoWallet cryptoCurrency(CryptoCurrency cryptoCurrency) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentToolDetailsCryptoWallet paymentToolDetailsCryptoWallet = (PaymentToolDetailsCryptoWallet) o;
    return Objects.equals(this.cryptoCurrency, paymentToolDetailsCryptoWallet.cryptoCurrency) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(cryptoCurrency, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentToolDetailsCryptoWallet {\n");
