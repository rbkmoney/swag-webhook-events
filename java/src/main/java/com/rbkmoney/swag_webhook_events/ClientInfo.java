...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T17:32:34.908+03:00[Europe/Moscow]")public class ClientInfo {
  ...
  * @return ip
  **/
  @Schema(description = "IP-адрес плательщика")
  public String getIp() {
    return ip;
  }
  ...
  * @return fingerprint
  **/
  @Schema(required = true, description = "Уникальный отпечаток user agent'а плательщика")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(ip, fingerprint);
  }
