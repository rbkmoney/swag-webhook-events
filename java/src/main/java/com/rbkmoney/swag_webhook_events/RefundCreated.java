...
import com.rbkmoney.swag_webhook_events.Payment;
import com.rbkmoney.swag_webhook_events.Refund;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
import java.time.OffsetDateTime;

/**
 * Событие о запуске рефанда в рамках платежа
 */
@Schema(description = "Событие о запуске рефанда в рамках платежа")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T14:43:15.170+03:00[Europe/Moscow]")public class RefundCreated extends Event {
  ...
  public RefundCreated invoice(Invoice invoice) {
  ...
  **/
  ...
  public RefundCreated payment(Payment payment) {
  ...
  **/
  ...
  public RefundCreated refund(Refund refund) {
    this.refund = refund;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RefundCreated refundCreated = (RefundCreated) o;
    return Objects.equals(this.invoice, refundCreated.invoice) &&
        Objects.equals(this.payment, refundCreated.payment) &&
        Objects.equals(this.refund, refundCreated.refund) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(invoice, payment, refund, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RefundCreated {\n");
