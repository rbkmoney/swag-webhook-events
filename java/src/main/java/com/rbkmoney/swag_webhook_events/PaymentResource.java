 ...
 */
@Schema(description = "Данные платежного средства")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T14:43:15.170+03:00[Europe/Moscow]")public class PaymentResource {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(paymentToolToken, paymentSession, paymentToolDetails, clientInfo);
  }
