...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T17:32:34.908+03:00[Europe/Moscow]")public class DigitalWalletDetailsQIWI extends DigitalWalletDetails {
  ...
  **/
  @Schema(example = "+7******3210", required = true, description = "Маскированный номер телефона плательщика в международном формате, выступающий в роли идентификатора кошелька Visa QIWI Wallet. ")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(phoneNumberMask, super.hashCode());
  }
