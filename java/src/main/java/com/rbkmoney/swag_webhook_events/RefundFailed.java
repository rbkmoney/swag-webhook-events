...
/**
 * Событие о неуспешном завершении рефанда
 */
@Schema(description = "Событие о неуспешном завершении рефанда")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T14:43:15.170+03:00[Europe/Moscow]")public class RefundFailed extends Event {
  ...
  public RefundFailed invoice(Invoice invoice) {
  ...
  **/
  ...
  public RefundFailed payment(Payment payment) {
  ...
  **/
  ...
  public RefundFailed refund(Refund refund) {
    this.refund = refund;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RefundFailed refundFailed = (RefundFailed) o;
    return Objects.equals(this.invoice, refundFailed.invoice) &&
        Objects.equals(this.payment, refundFailed.payment) &&
        Objects.equals(this.refund, refundFailed.refund) &&
        super.equals(o);
  }
