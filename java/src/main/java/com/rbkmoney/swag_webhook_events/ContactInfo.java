 ...
 */
@Schema(description = "Контактные данные плательщика")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T17:32:34.908+03:00[Europe/Moscow]")public class ContactInfo {
  ...
  **/
  ...
  /**
  * Номер мобильного телефона с международным префиксом согласно [E.164](https://en.wikipedia.org/wiki/E.164). 
  * @return phoneNumber
  **/
  @Schema(description = "Номер мобильного телефона с международным префиксом согласно [E.164](https://en.wikipedia.org/wiki/E.164). ")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(email, phoneNumber);
  }
