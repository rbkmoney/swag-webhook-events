...
/**
 * Событие об отмене платежа, в результате которого списание денежных средств с плательщика аннулируется 
 */
@Schema(description = "Событие об отмене платежа, в результате которого списание денежных средств с плательщика аннулируется ")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T17:32:34.908+03:00[Europe/Moscow]")public class PaymentCancelled extends Event {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentCancelled paymentCancelled = (PaymentCancelled) o;
    return Objects.equals(this.invoice, paymentCancelled.invoice) &&
        Objects.equals(this.payment, paymentCancelled.payment) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(invoice, payment, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentCancelled {\n");
