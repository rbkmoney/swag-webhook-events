...
import com.rbkmoney.swag_webhook_events.CustomerBindingStatus;
 ...
 */
@Schema(description = "Привязка плательщика к платежному средству")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T14:43:15.170+03:00[Europe/Moscow]")public class CustomerBinding extends CustomerBindingStatus {
  ...
  * @return id
  **/
  @Schema(required = true, description = "Идентификатор привязки")
  public String getId() {
    return id;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, customerBinding.id) &&
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, paymentResource, super.hashCode());
  }
