...
import com.rbkmoney.swag_webhook_events.PaymentRecurrentParent;
 ...
 */
@Schema(description = "Многоразовое платежное средство на основе другого платежа")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-05T14:43:15.170+03:00[Europe/Moscow]")public class RecurrentPayer extends Payer {

  @SerializedName("contactInfo")
  private ContactInfo contactInfo = null;

  @SerializedName("recurrentParentPayment")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(contactInfo, recurrentParentPayment, super.hashCode());
  }
