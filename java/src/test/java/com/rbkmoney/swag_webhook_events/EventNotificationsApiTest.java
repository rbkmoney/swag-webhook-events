...
/**
 * API tests for EventNotificationsApi
 */
@Ignore
public class EventNotificationsApiTest {

    private final EventNotificationsApi api = new EventNotificationsApi();
     ...
     */
    @Test
    public void notifyWebhookEventTest() throws ApiException {
        Event body = null;
        String contentSignature = null;
        api.notifyWebhookEvent(body, contentSignature);
